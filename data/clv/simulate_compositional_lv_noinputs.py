...
for Dx in range(1, 11):
    for scale in [1]:
        ...
        # percentage
        data_dir = repo_dir + "/data/clv/data_noinput/clv_percentage_Dx_{}_scale_{}.p".format(Dx, scale)
        with open(data_dir, "wb") as f:
            pickle.dump(p_data, f)

        # count
        data_dir = repo_dir + "/data/clv/data_noinput/clv_count_Dx_{}_scale_{}.p".format(Dx, scale)
        with open(data_dir, "wb") as f:
